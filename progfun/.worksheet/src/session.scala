object session {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(60); 
  ...
  y + y;System.out.println("""res1: Rational = """ + $show(res$1));$skip(8); val res$2 = 
  x < y;System.out.println("""res2: Boolean = """ + $show(res$2));$skip(10); val res$3 = 
  x max y;System.out.println("""res3: Rational = """ + $show(res$3));$skip(21); val res$4 = 
  
  new Rational(2);System.out.println("""res4: Rational = """ + $show(res$4))}
}
